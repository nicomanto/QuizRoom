...
PrincipalForm::PrincipalForm(User* u,Controller& c,bool & r,QWidget *parent): BaseForm(parent), menubar(nullptr), scroll(nullptr), container_scroll(new QGroupBox(scroll)),user(u),relogin(r),control(c){
