...
HomeworkForm::HomeworkForm(User* u,QWidget *parent): PrincipalForm(u,parent),homework_title(new QLabel("Titolo",this)),homework_instructions(new QLabel("Esegui questo quiz e bla bla blajcdsqijbucqbiocnoinqiconeonqeicnioqcnioqen webchbeqj e e e e e e e e e ee  e e e e e  e e e ec",this)),
...
void HomeworkForm::to_addquiz(){
    emit to_new_page(new ContainerAddQuizForm(user,parentWidget()));

    close();
}

void HomeworkForm::to_next_page(){
    emit to_new_page(new ContainerQuizForm(user,parentWidget()));
